...
import com.yunyi.component.LoginHandlerInterceptor;
...
public class MvcConfig implements WebMvcConfigurer, ErrorPageRegistrar {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new LoginHandlerInterceptor()).addPathPatterns("/**")
                .excludePathPatterns(
                        "/connection","/loginByQQ","/temp-file","/", "/error400Page", "/error401Page", "/error404Page", "/error500Page", "/admin", "/sendCode", "/login", "/uploadTempFile","/register", "/file/share",
