...
import com.yunyi.utils.MailUtils;
...
public class LoginController extends BaseController {
    ...
    public String adminLogin(){
        User user = userService.getUserByEmail("123@qq.com");
    ...
    public String register(User user, String code, Map<String, Object> map) {
        ...
        user.setImagePath("https://yiyi-cloud.oss-cn-beijing.aliyuncs.com/yi-cloud/avatar.jpg");
